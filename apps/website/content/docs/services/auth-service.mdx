...
<div style={{ display: 'flex', gap: '8px', marginBottom: '16px' }}>
  {[
    {
      url: "https://ci.tklein.it/api/v1/teams/budgetbuddyde/pipelines/auth-service/jobs/build-auth-service/badge?title=Build",
      alt: "CI Build Status"
    },
    {
      url: "https://img.shields.io/github/v/tag/budgetbuddyde/budgetbuddyde?filter=auth-service*&cacheSeconds=3600",
      alt: "Version"
    }
  ].map(({url, alt}) => (
    <img 
...
- [`@budgetbuddyde/db`](/docs/packages/db)
