...
export class AttachmentHandler {
   ...
   */
  protected async verifyOwnership(attachmentId: string, userId: string): Promise<AttachmentRecord | null> {
   ...
   */
  protected async findByOwnerAndUsage(userId: string, usage: TAttachmentUsage) {
