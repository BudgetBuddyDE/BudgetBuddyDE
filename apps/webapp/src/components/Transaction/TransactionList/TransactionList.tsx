        ...
        {data.length > 0 ? (
          data.map(transaction => (
            <ListWithIcon
              ...
              subtitle={
                <Box>
                  <Chip label={Formatter.date.format(transaction.processedAt, true)} sx={{mr: 1}} {...chipProps} />
                  <CategoryChip categoryName={transaction.category.name} {...chipProps} />
                  <PaymentMethodChip paymentMethodName={transaction.paymentMethod.name} {...chipProps} />
                </Box>
              }
