...
export const ISIN = z.string().max(12, {message: 'ISIN can only be 12 characters long'});
export const WKN = z.string().max(6, {message: 'WKN can only be 6 characters long'});
