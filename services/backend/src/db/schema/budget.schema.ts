...
/**
 * Schema for creating an budget including categories for the `budget_category`-table
 */
...
/**
 * Schema for updating an existing budget including categories for the `budget_category`-table
 */
