...
export default class ErrorBoundary extends React.Component<ErrorBoundaryProps, ErrorBoundaryState> {
  ...
  private haveResetKeysChanged(prevKeys?: Array<unknown>, nextKeys?: Array<unknown>) {
 ...
 */
export function PathnameErrorBoundary(props: Omit<ErrorBoundaryProps, 'resetKeys'>) {
