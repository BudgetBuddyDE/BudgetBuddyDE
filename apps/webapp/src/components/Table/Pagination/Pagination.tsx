 ...
 */
export type PaginationProps = Pick<MuiTablePaginationProps, 'count' | 'page' | 'rowsPerPage' | 'labelRowsPerPage'> & {
  /**
...
export const Pagination: React.FC<PaginationProps> = ({
  ...
  }, [validPage, validRowsPerPage, onPageChange, onRowsPerPageChange, page, rowsPerPage]);
