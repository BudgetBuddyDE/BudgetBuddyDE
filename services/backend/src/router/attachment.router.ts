...
import {AttachmentHandler} from '../lib/attachment';
...
const attachmentService = new AttachmentHandler(process.env.AWS_S3_BUCKET_NAME as string);

attachmentRouter.get(
  '/',
  validateRequest({
    // TODO: When required, implement a pagination as well as filtering by a specific transactionId in order to avoid listing all attachments at once
    query: z.object({
