...
export type TCreateOrUpdateSubscription = Partial<
	z.infer<typeof CreateOrUpdateSubscription>
>;

// Response from OData
export const SubscriptionResponse = Subscription.extend(
 ...
 */
export type TExpandedSubscriptionsWithCount = z.infer<
	typeof ExpandedSubscriptionsWithCount
>;
