...
export type TAsset = z.infer<typeof BackendSchemas.Asset>;
export type TAssetQuote = z.infer<typeof BackendSchemas.AssetQuote>;
...
export const StockPosition = z.object({
	...
	purchaseFee: z
		.number()
		.min(0, { message: "Purchase fee cannot be negative" })
		.default(0),
...
export type TCreateOrUpdateStockPosition = z.infer<
	typeof CreateorUpdateStockPosition
>;

// Response from OData
export const StockPositionResponse = StockPosition.extend(
	ODataContextAspect.shape,
);
