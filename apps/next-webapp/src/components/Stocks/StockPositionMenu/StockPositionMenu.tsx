...
import { type StockPositionTableProps } from '../StockPositionTable';

export const StockPositionMenu: React.FC<
  Pick<StockPositionTableProps, 'onEditPosition' | 'onDeletePosition'> & { position: any }
  ...
  return (
    <React.Fragment>
      ...
      <Menu
        ...
        slotProps={{
          paper: {
            sx: { boxShadow: 'none', border: (theme) => `1px solid ${theme.palette.divider}` },
          },
        }}
      >
        {onEditPosition && (
