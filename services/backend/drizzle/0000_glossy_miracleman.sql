...
CREATE VIEW "budgetbuddy_backend"."transaction_receiver_view" AS ((select distinct "receiver", "owner_id" from "budgetbuddy_backend"."transaction") union all (select distinct "receiver", "owner_id" from "budgetbuddy_backend"."recurring_payment"));