...
describe('isCSRFCheckDisabled', () => {
  ...
  test('it should return true if DISABLE_CSRF_CHECK is set to "true"', () => {
    process.env.DISABLE_CSRF_CHECK = 'true';

    expect(isCSRFCheckDisabled()).toBeTruthy();
  });

  test('it should return false if DISABLE_CSRF_CHECK is set to "false"', () => {
    process.env.DISABLE_CSRF_CHECK = 'false';
    expect(isCSRFCheckDisabled()).toBeFalsy();
  });

  test('it should return false if DISABLE_CSRF_CHECK is not set', () => {
    delete process.env.DISABLE_CSRF_CHECK;
    expect(isCSRFCheckDisabled()).toBeFalsy();
  });

  test('it should return false if DISABLE_CSRF_CHECK is set to any other value', () => {
