...
<div style={{ display: 'flex', gap: '8px', marginBottom: '16px' }}>
  {[
    {
      url: "https://ci.tklein.it/api/v1/teams/budgetbuddyde/pipelines/api/jobs/build-api/badge",
      alt: "CI Build Status"
    },
    {
      url: "https://img.shields.io/npm/v/%40budgetbuddyde%2Fapi",
      alt: "NPM Version"
    },
    {
      url: "https://img.shields.io/npm/l/%40budgetbuddyde%2Fapi?label=License",
      alt: "NPM License"
    },
    {
      url: "https://img.shields.io/npm/last-update/%40budgetbuddyde%2Fapi?label=Last%20Update",
      alt: "NPM Last Update"
    },
  ].map(({url, alt}) => (
    <img 
