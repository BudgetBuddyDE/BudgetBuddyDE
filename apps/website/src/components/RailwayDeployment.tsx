...
export default function RailwayDeployment(props: HTMLAttributes<HTMLDivElement>) {
  return (
    ...
    >
      ...
      <NextLink href="https://railway.com/deploy/ezasWl?referralCode=SD-6Xm&utm_medium=integration&utm_source=template&utm_campaign=generic" target="_blank" rel="noopener noreferrer">
